...
class PluginADLowVersionDCWin2K(PluginADScanBase):
    """存在过低的域控制器操作系统版本（Windows-2000）"""

    display = "存在过低的域控制器操作系统版本（Windows-2000）"
    alias = "low_ver_dc_win2k"
...
#        query = "(&(objectclass=computer)(primaryGroupID=516)(|(operatingSystem=Windows 2000*)(operatingSystem=Windows Server 2000*)))"
        query = "(&(|(primarygroupid=516)(primarygroupid=521))(|(operatingSystem=*2000*)(operatingSystem=*2000*)))"
