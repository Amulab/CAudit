...
class PluginADLowVersionComputerWin2K3(PluginADScanBase):
    """存在过低的操作系统版本（Windows-2003）"""

    display = "存在过低的操作系统版本（Windows-2003）"
    alias = "low_ver_cpt_win2k3"
    ...
    def run_script(self, args) -> dict:
        ...
        #        query = "(&(objectclass=computer)(|(operatingSystem=Windows Server 2003*)(operatingSystem=Windows 2003*)))"
        query = "(&(objectclass=computer)(operatingSystem = *2003*))"
