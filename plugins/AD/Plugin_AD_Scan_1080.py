...
class PluginADAuditDCProcess(PluginADScanBase):
    """审核策略中审核进程跟踪未正常开启"""
    display = "审核策略中审核进程跟踪未正常开启"
    alias = "AuditDCProcess"
    ...
    def findfile(self, line, path):
        ...
        if line == 0:
            ...
            instance["Status"] = "审核策略中审核进程跟踪未开启审核"
            return instance
            ...
            instance = {}
            instance["Matching file"] = path
            instance["Status"] = "审核策略中审核进程跟踪未开启失败审核"
            return instance
            # instance_list.append(
            #     instance)
            # return instance_list
            ...
            instance = {}
            instance["Matching file"] = path
            instance["Status"] = "审核策略中审核进程跟踪未开启成功审核"
            return instance
            # instance_list.append(
            #     instance)
            # return instance_list
                            ...
                            if sharedfile.get_longname().endswith('.' + 'csv'):
                                ...
                                if len(results) != 0:
                                    ...
                                    if flag1 == 0:
                                        ...
                                        instance = {}
                                        instance["Matching file"] = path
                                        instance["Status"] = "审核策略中审核进程跟踪未配置"
