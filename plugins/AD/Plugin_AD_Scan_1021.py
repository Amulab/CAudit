...
class PluginADLowVersionComputerWin7(PluginADScanBase):
    """存在过低的操作系统版本（Windows7）"""

    display = "存在过低的操作系统版本（Windows7）"
    alias = "low_ver_cpt_win7"
    ...
    def run_script(self, args) -> dict:
        ...
        #        query = "(&(objectclass=computer)(operatingSystem=Windows 7*))"
        query = "(&(objectclass=computer)(operatingSystem=*7*))"
