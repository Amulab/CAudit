...
class PluginADLowVersionComputerWin2K(PluginADScanBase):
    """存在过低的操作系统版本（Windows-2000）"""

    display = "存在过低的操作系统版本（Windows-2000）"
    alias = "low_ver_cpt_win2k"
    ...
    def run_script(self, args) -> dict:
        ...
        #        query = "(&(objectclass=computer)(|(operatingSystem=Windows Server 2000*)(operatingSystem=Windows 2000*)))"
        query = "(&(objectclass=computer)(operatingSystem = *2000*))"
