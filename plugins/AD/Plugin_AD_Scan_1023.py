...
class PluginADLowVersionComputerWinxp(PluginADScanBase):
    """存在过低的操作系统版本（Windows-XP）"""

    display = "存在过低的操作系统版本（Windows-XP）"
    alias = "low_ver_cpt_winxp"
    ...
    def run_script(self, args) -> dict:
        ...
        #        query = "(&(objectclass=computer)(operatingSystem=Windows XP*))"
