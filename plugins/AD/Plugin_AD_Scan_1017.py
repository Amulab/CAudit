...
class PluginADLowVersionDCWin2K8(PluginADScanBase):
    """存在过低的域控制器操作系统版本（Windows-2008）"""

    display = "存在过低的域控制器操作系统版本（Windows-2008）"
    alias = "low_ver_dc_win2k8"
...
#        query = "(&(objectclass=computer)(primaryGroupID=516)(|(operatingSystem=windows Server 2008*)(operatingSystem=windows 2008*)))"
        query = "(&(|(primarygroupid=516)(primarygroupid=521))(operatingSystem=*2008*))"
