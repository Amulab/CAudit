...
class PluginExchangeInvalidIdleLockTime(PluginExchangeScanBase):
    """空闲锁定时间设置不合理"""

    display = "空闲锁定时间设置不合理"
    alias = "ex_inv_idle_time"
    ...
    def run_script(self, args) -> dict:
        ...
        for entry1 in entry_generator:
            ...
            attributes = ["msExchMobileMaxInactivityTimeDeviceLock", "cn"]
            ...
            for entry2 in entry_generator2:
                ...
                if not entry2["attributes"]['msExchMobileMaxInactivityTimeDeviceLock'] or entry2["attributes"]['msExchMobileMaxInactivityTimeDeviceLock'] > 900:
                    result['status'] = 1
                    instance ={}
                    instance["空闲锁定时间"] = entry2["attributes"]['msExchMobileMaxInactivityTimeDeviceLock']
