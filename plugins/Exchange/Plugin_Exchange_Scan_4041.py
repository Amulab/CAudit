...
class PluginExchangeInvalidMobileRefreshTime(PluginExchangeScanBase):
    """移动设备策略刷新时间不合理"""

    display = "移动设备策略刷新时间不合理"
    alias = "ex_inv_refresh_tm"
    ...
    def run_script(self, args) -> dict:
        ...
        for entry1 in entry_generator:
            ...
            attributes = ["msexchmobiledevicepolicyrefreshinterval", "cn"]
            ...
            for entry2 in entry_generator2:
                ...
                if entry2["attributes"]['msexchmobiledevicepolicyrefreshinterval'] != 3600:
                    result['status'] = 1
                    instance ={}
                    instance["策略名称"] = entry2["attributes"]['cn']
