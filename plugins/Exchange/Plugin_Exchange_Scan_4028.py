...
class PluginExchangeNoConnectLog(PluginExchangeScanBase):
    """连接日志记录未开启"""

    display = "连接日志记录未开启"
    alias = "ex_no_conn_log"
        ...
        for entry in entry_generator:
            ...
            for entry1 in entry_generator1:
                ...
                for entry2 in entry_generator2:
                    attributes = ["msExchTransportFlags", "cn"]
                    ...
                    for entry3 in entry_generator3:
                        if entry3["attributes"]['msExchTransportFlags'] & int("0b10000000000000", 2) == 0:
                            result['status'] = 1
                            instance ={}
                            instance["msExchTransportFlags"] = entry3["attributes"]['msExchTransportFlags']
