        ...
        for entry in entry_generator:
            ...
            for entry1 in entry_generator1:
                ...
                for entry2 in entry_generator2:
                    attributes = ["msExchEncryptionRequired", "cn"]
                    ldap_cli3 = "CN=RpcClientAccess,CN=Protocols,CN=" + entry2["attributes"]['cn'] + "," + ldap_cli2
                    ...
                    for entry3 in entry_generator3:
                        if not entry3["attributes"]['msExchEncryptionRequired']:
                            result['status'] = 1
                            instance ={}
                            instance["影响对象"] = entry3["attributes"]['cn']
