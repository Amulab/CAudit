...
class PluginExchangeUMServerNoTls(PluginExchangeScanBase):
    """UM服务的启动模式未启用TLS"""

    display = "UM服务的启动模式未启用TLS"
    alias = "ex_no_um_tls"
        ...
        for entry in entry_generator:
            ...
            for entry1 in entry_generator1:
                ...
                for entry2 in entry_generator2:
                    attributes = ["msExchUMStartupMode", "cn"]
                    ...
                    for entry3 in entry_generator3:
                        if not  entry3["attributes"]['msExchUMStartupMode'] or entry3["attributes"]['msExchUMStartupMode'] != 1:
                            result['status'] = 1
                            instance ={}
                            instance["msExchUMStartupMode"] = entry3["attributes"]['cn']
