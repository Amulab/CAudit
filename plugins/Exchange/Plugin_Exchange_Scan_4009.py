                ...
                for entry2 in entry_generator2:
                    ...
                    for entry3 in entry_generator3:
                        if entry3["attributes"]['cn'] == "Text Messaging Delivery Agent Connector":
                            continue
                        attributes = ["msExchSmtpOutboundSecurityFlag", "cn"]
                        ...
                        for entry4 in entry_generator4:
                            if entry4["attributes"]['msExchSmtpOutboundSecurityFlag'] & int("0b100000000000000000000000", 2):
                                result['status'] = 1
                                instance ={}
                                instance["外部发送连接器"] = entry4["attributes"]['cn']
