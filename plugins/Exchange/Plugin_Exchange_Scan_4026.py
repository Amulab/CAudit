...
class PluginExchangeNoSmime(PluginExchangeScanBase):
    """SMIME未启用"""
        ...
        for entry in entry_generator:
            ...
            for entry1 in entry_generator1:
                ...
                for entry2 in entry_generator2:
                    attributes = ["msExchMailboxFolderSet", "cn"]
                    ldap_cli3 = "CN=owa (Default Web Site),CN=HTTP,CN=Protocols,CN=" + entry2["attributes"]['cn'] + "," + ldap_cli2
                    ...
                    for entry3 in entry_generator3:
                        if entry3["attributes"]['msExchMailboxFolderSet'] == -2049:
                            result['status'] = 1
                            instance ={}
