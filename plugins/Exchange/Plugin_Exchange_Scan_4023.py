...
class PluginExchangeInvalidMinimumPwd(PluginExchangeScanBase):
    """移动设备最小密码长度设置过小"""

    display = "移动设备最小密码长度设置过小"
    alias = "ex_inv_mini_pwd"
    ...
    def run_script(self, args) -> dict:
        ...
        for entry1 in entry_generator:
            ...
            attributes = ["msExchMobileMinDevicePasswordLength", "cn"]
            ...
            for entry2 in entry_generator2:
                ...
                if not entry2["attributes"]['msExchMobileMinDevicePasswordLength'] or entry2["attributes"]['msExchMobileMinDevicePasswordLength'] < 6:
                    result['status'] = 1
                    instance ={}
                    instance["最小密码长度 "] = entry2["attributes"]['cn']
