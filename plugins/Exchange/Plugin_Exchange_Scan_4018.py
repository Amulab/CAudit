...
class PluginExchangeAllowUnmanagedDevices(PluginExchangeScanBase):
    """允许未管理的设备"""

    display = "允许未管理的设备"
    alias = "ex_allow_um_device"
    ...
    def run_script(self, args) -> dict:
        ...
        for entry1 in entry_generator:
            ...
            for entry2 in entry_generator2:
                ...
                if entry2["attributes"]['msExchMobileFlags'] & int("0b100000000000000000", 2):
                    result['status'] = 1
                    instance = {}
