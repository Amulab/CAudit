...
class PluginExchangeMobileDeviceNoPwd(PluginExchangeScanBase):
    """已启用移动设备登录不需要密码"""

    display = "已启用移动设备登录不需要密码"
    alias = "ex_enable_mob_no_pwd_login"
    ...
    def run_script(self, args) -> dict:
        ...
        for entry1 in entry_generator:
            ...
            for entry2 in entry_generator2:
                ...
                if entry2["attributes"]['msexchmobileflags'] & int("0b00010", 2) == 0:
                    result['status'] = 1
                    instance ={}
